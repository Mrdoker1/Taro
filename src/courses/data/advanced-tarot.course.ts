...
export const advancedTarotCourse: Partial<Course> = {
  "slug": "advanced-tarot",
  ...
  "translations": {
    "ru": {
      ...
      "description": "Углубленное изучение Таро. Сложные расклады, комбинации карт, астрологические соответствия и профессиональная практика.",
      "chapters": [
        {
    ...
    "en": {
      ...
      "description": "Deep dive into Tarot. Complex spreads, card combinations, astrological correspondences, and professional practice.",
      "chapters": [
        {
