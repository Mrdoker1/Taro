...
export const basicTaroCourse: Partial<Course> = {
  ...
  translations: {
    ru: {
      ...
      description:
        'Изучите основы Таро с нуля: структура колоды, чтение символов, Старшие Арканы, база Младших Арканов и простые расклады.',
      chapters: [
        {
          title: 'Старт',
          pages: [
    ...
    en: {
      ...
      description:
        'Learn Tarot from scratch: deck structure, how to read symbols, Major Arcana, a foundation of the Minor Arcana, and simple spreads.',
      chapters: [
        {
          title: 'Start',
          pages: [
